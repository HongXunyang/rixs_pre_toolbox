...
from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QFormLayout,
                            ...
                            QTextEdit, QSplitter, QSpinBox, QCheckBox)
...
class PlaceholderTab(TabInterface):
    ...
    def create_input_panel(self, parent_layout):
        ...
        input_layout.addLayout(data_type_form)
    ...
    def create_processing_panel(self, parent_layout):
        ...
        processing_layout.addLayout(process_type_form)
        ...
        processing_layout.addLayout(params_form)
    ...
    def create_visualization_panel(self, parent_layout):
        ...
        visualization_layout.addLayout(vis_type_form)
        ...
        visualization_layout.addLayout(customize_form)
