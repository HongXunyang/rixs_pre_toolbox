...
class BrillouinVisualizerTab(TabInterface):
    ...
    def create_structure_input(self, parent_layout):
        ...
        structure_layout.addWidget(input_tabs)
        ...
        file_button_layout.addWidget(self.file_path_input)
        file_button_layout.addWidget(browse_button)
        
        file_form.addRow("CIF File:", file_button_layout)
        ...
        manual_layout.addLayout(lattice_form)
        ...
        manual_layout.addWidget(constants_group)
        ...
        manual_layout.addWidget(load_manual_button)
        
        input_tabs.addTab(manual_tab, "Manual Input")
        
        # Add to parent layout
        parent_layout.addWidget(structure_group)
    ...
    def create_view_controls(self, parent_layout):
        ...
        view_layout.addLayout(direction_form)
        ...
        view_layout.addWidget(self.show_points_check)
    ...
    def create_path_controls(self, parent_layout):
        ...
        path_layout.addWidget(points_label)
        ...
        path_buttons_layout.addWidget(add_point_button)
        
        clear_path_button = QPushButton("Clear Path")
        clear_path_button.clicked.connect(self.clear_path)
        path_buttons_layout.addWidget(clear_path_button)
